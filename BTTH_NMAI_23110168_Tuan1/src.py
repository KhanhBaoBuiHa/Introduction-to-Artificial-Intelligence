...
# Hàm chuyển ma trận kề → danh sách kề (đồ thị không trọng số)
def convert_graph(a):
...
# Hàm chuyển ma trận kề → danh sách kề (đồ thị có trọng số)
